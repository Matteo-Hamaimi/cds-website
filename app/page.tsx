  ...
  return (
    <>
      ...
      <section id="hero" style={{ position: 'relative', height: '100svh', minHeight: 500, overflow: 'hidden', display: 'flex', alignItems: 'flex-start', justifyContent: 'center' }}>
        <div style={{ position: 'absolute', inset: 0, backgroundImage: "url('/team/hero.jpg')", backgroundSize: 'cover', backgroundPosition: 'center 35%', filter: 'brightness(.48) saturate(.75)' }} />
